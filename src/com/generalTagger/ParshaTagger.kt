        ...
        processShiurim@ for (file in listOfMp3s) {
            ...
            checkForDate@ while (true) {
                ...
                if (numberOfMatchesInTitle == 0 && yearGivenInFile) break@checkForDate
                    ...
                    rejects[title] = "No Date Given In File Nor In Title.";continue@processShiurim
                } else {
                    ...
                    if (numberOfMatchesInTitle == 1 && !yearGivenInFile) year = yearInTitle
                        ...
                        rejects[title] = "Different Year In Title($yearInTitle) Than In File($year). Unable To Determine Correct Year."
                        continue@processShiurim
                        ...
                        rejects[title] = "Two Or More Years In Title: $datesFound. Unable To Determine Correct Year."
                        continue@processShiurim
                    }
                }
                break@checkForDate
            ...
            if (year != "") {
                ...
                println("Year still equals \"\". Unacceptable. I just tried to set the year of the shiur and the year was blank.")
                exitProcess(666)
            }
