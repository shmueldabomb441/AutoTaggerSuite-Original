...
public class GeneralTaggerJavaCodeStyleTestDummy {
    ...
    public GeneralTaggerJavaCodeStyleTestDummy() throws IOException /*Singleton Pattern Constructor*/{
        try{
    ...
    public static List<String> listRunningProcesses() throws IOException {
        ...
        try {
            ...
            GeneralTaggerJavaCodeStyleTestDummy a= new GeneralTaggerJavaCodeStyleTestDummy();
